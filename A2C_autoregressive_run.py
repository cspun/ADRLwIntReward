...
# customized env
from env.EnvMultipleStock_train_A import StockEnvTrain
from env.EnvMultipleStock_validation_A import StockEnvValidation
from env.EnvMultipleStock_trade_A import StockEnvTrade
import os
...
def run_a2c_ensemble_strategy(df, reward_func, unique_trade_date, rebalance_window, validation_window, timesteps,v_in_coef, v_ex_coef, r_in_coef, ent_coef, lr_alpha, lr_beta, 
    ...
    for i in range(rebalance_window + validation_window, len(unique_trade_date) , rebalance_window):
        ...
        print(f'==============R{r_in_coef} and seed{seed}======================')
