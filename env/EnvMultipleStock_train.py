...
### StockEnvTrain() is an object of type gym.Env
class StockEnvTrain(gym.Env):
    ...
    def __init__(self, df,day = 0):
        ...
        # action_space normalization and shape is STOCK_DIM=30
    ...
    def step(self, actions):
        ...
        if self.terminal:    #when terminal state reached, plot the memory of account value, cal end value, cal annualized sharpe ratio
            ...
            argsort_actions = np.argsort(actions)    #argsort(): returns the order of indicies that would sort the data
